    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
                ...
                <li class=" nav-item"><a href=""><i class="bi bi-house-door-fill"
                ...
                <li class="{{ Request::routeIs('') ? 'active' : '' }} nav-item">
                    <a href=""><i class="bi bi-people-fill"style="margin-top: 3px;"></i><span
                ...
                <li class="{{ Request::routeIs('work') ? 'active' : '' }} nav-item"><a href=""><i
                ...
                <li class="{{ Request::routeIs('salary') ? 'active' : '' }} nav-item"><a href=""><i
                            class="bi bi-cash"style="margin-top: 3px;"></i><span class="menu-title"
                            data-i18n="Chat"style="font-size: 18px; ">จัดการเงินเดือน</span></a>
                </li>
                <li class="{{ Request::routeIs('') ? 'active' : '' }} nav-item"><a href=""><i
                    ...
                    <ul class="menu-content">
                        <li class="{{ Request::routeIs('sumleavework') ? 'active' : '' }} nav-item"><a
                                href=""><i class="feather icon-circle"style="font-size: 1.2rem;"></i><span
                                    class="menu-item" data-i18n="Checkout">ประวัติการลา</span></a>
                        </li>
                        <li class="{{ Request::routeIs('absent') ? 'active' : '' }} nav-item"><a href=""><i
                ...
                <li class="{{ Request::routeIs('stock') ? 'active' : '' }} nav-item">
                    <a href=""><i class="bi bi-box-seam"style="margin-top: 3px;"></i><span class="menu-title"
                            data-i18n="Todo"style="font-size: 18px; ">ทรัพย์สิน</span></a>
                    <ul class="menu-content">
                        <li class="{{ Request::routeIs('stock') ? 'active' : '' }} nav-item"><a href=""><i
                                    class="feather icon-circle" style="font-size: 1.2rem;"></i><span
                                    class="menu-item" data-i18n="Shop">รายการทรัพย์สิน</span></a>
                        </li>
                        <li class="{{ Request::routeIs('addInventory') ? 'active' : '' }} nav-item"><a
                                href=""><i class="feather icon-circle" style="font-size: 1.2rem;"></i><span
                                    class="menu-item" data-i18n="Shop">เพิ่มทรัพย์สิน</span></a>
                        </li>
                        <li class="{{ Request::routeIs('stockmath') ? 'active' : '' }} nav-item"><a href=""><i
                                    class="feather icon-circle" style="font-size: 1.2rem;"></i><span
                                    class="menu-item" data-i18n="Details">ค่าเสื่อม</span></a>
                        </li>
                ...
                <li class="{{ Request::routeIs('departsetting') ? 'active' : '' }} nav-item"><a href=""><i
                    ...
                    <ul class="menu-content">
                        <li class="{{ Request::routeIs('departsetting') ? 'active' : '' }} nav-item"><a
                                href=""><i class="feather icon-circle" style="font-size: 1.2rem;"></i><span
                                    class="menu-item" data-i18n="Details">ประเภทแผนก</span></a>
                        </li>
                        <li class="{{ Request::routeIs('stocksetting') ? 'active' : '' }} nav-item"><a
                                href=""><i class="feather icon-circle" style="font-size: 1.2rem;"></i><span
                                    class="menu-item" data-i18n="Checkout">ประเภททรัพย์สิน </span></a>
                        </li>
                        <li class="{{ Request::routeIs('unitsetting') ? 'active' : '' }} nav-item"><a
                                href=""><i class="feather icon-circle" style="font-size: 1.2rem;"></i><span
                                    class="menu-item" data-i18n="Checkout">หน่วยนับ </span></a>
                        </li>
                        <li class="{{ Request::routeIs('tax') ? 'active' : '' }} nav-item"><a href=""><i
                                    class="feather icon-circle" style="font-size: 1.2rem;"></i><span
                                    class="menu-item" data-i18n="Checkout">ใบแจ้งเงินเดือน
                                </span></a>
                        </li>
                    </ul>
                </li>
